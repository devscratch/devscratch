...
<html lang="en">
   <head>
      ...
      <title>devscratch.com - @yield('title')</title>
      <!-- Favicons -->
      ...
      <!--  Page CSS -->
      <link rel="stylesheet" href="assets/css/dashboard/dashboard_v2.css" />
   ...
   <body class="dashboard2 site-navbar-small">
         ...
         <div class="navbar-container container-fluid">
            <div class="collapse navbar-collapse navbar-block navbar-collapse-toolbar" id="site-navbar-collapse">
               ...
               <div class="utmenucontainer">
                  ...
                  <nav class="utmenu">
                     <ul class="mobile-sub utmenu-list">
                        ...
                        <li>
                           <a class="waves-effect waves-light" href="javascript:void(0)"> <i class="fa fa-newspaper-o" aria-hidden="true"></i> ARTICLE <span class="arrow_carrot-down" aria-hidden="true"></span></a>
                        ...
                        <li>
                           <a class="waves-effect waves-light" href="javascript:void(0)"> <i class="fa fa-film" aria-hidden="true"></i> SERIES <span class="arrow_carrot-down" aria-hidden="true"></span></a>
                           <ul class="utmenu-submenu">
                              <li>
                        ...
                        <li>
                           <span class="wsmenu-click"></span><a class="waves-effect waves-light" href="javascript:void(0)"> <i class="fa fa-puzzle-piece fa-2.comx" aria-hidden="true"></i> SKILLS <span class="arrow_carrot-down" aria-hidden="true"></span></a>
                           <ul class="utmenu-submenu">
                              <li>
               ...
               <ul class="nav navbar-nav navbar-toolbar navbar-right">
                  ...
                  @if(Auth::guest())
                    <li id="login-icon">
                      <a class="icon icon_profile waves-effect waves-light" href="{{url('/login?utm_source=m9201&hash_id=' . md5(uniqid()))}}">
                      </a>
                    </li>
                 @else
                  <li class="dropdown">
                   ...
                   @endif
                     ...
                     <ul class="dropdown-menu position-absolute" role="menu">
                         <li role="presentation">
                           <a href="{{url('/mastah/' . Auth::user()->nickname)}}" role="menuitem">Hallo, {{Auth::user()->name}}</a>
                         </li>
                         <li class="divider" role="presentation"></li>
                        <li role="presentation">
                           <a href="{{url('/mastah/' . Auth::user()->nickname)}}" role="menuitem"><i class="icon icon_profile" aria-hidden="true"></i> Profile</a>
                        </li>
                        <li role="presentation">
                        ...
                        <li class="divider" role="presentation"></li>
                        <li role="presentation">
                           <a href="{{url('/logout?hash_id=' . md5(uniqid()))}}" role="menuitem"><i class="icon icon_lock_alt" aria-hidden="true"></i> Logout</a>
                        </li>
                     </ul>
                  </li>
                  ...
                  <li id="chatbox">
                     <!--  Chat Box -->
                     <a class="waves-effect waves-light" data-toggle="site-sidebar" href="javascript:void(0)" title="Chat" data-url="site-sidebar.tpl">
      ...
      <script src="assets/js/dashboard/dashboard_v2.js"></script>
